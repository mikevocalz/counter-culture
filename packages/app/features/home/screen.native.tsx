...
const FEED_DATA: Post[] = [
  ...
  },
  {
    ...
    timestamp: '12h ago',
    content:
      'Late-night coding session fueled by neon lights and cold brew. Ship it while the skyline still glows!',
    ...
    commentPreviews: [
      {
        user: 'Maya Patel',
        avatar: 'https://images.pexels.com/photos/1181713/pexels-photo-1181713.jpeg?auto=compress&cs=tinysrgb&w=400',
        text: 'Love the city lights + focus combo!',
      },
      {
        user: 'Leo Grant',
        avatar: 'https://images.pexels.com/photos/927022/pexels-photo-927022.jpeg?auto=compress&cs=tinysrgb&w=400',
        text: 'Cold brew is the real MVP. Keep going!'
      },
      {
        user: 'Gia Flores',
        avatar: 'https://images.pexels.com/photos/1181713/pexels-photo-1181713.jpeg?auto=compress&cs=tinysrgb&w=400',
        text: 'Need to see the release notes soon 💬',
      },
    ],
  },
  {
    ...
    timestamp: '1d ago',
    content:
      'Took the morning to hike the ridge trail and it really cleared my head. Nature helps me design better features.',
    image: 'https://images.pexels.com/photos/1236701/pexels-photo-1236701.jpeg?auto=compress&cs=tinysrgb&w=800',
    likes: 514,
    comments: 64,
    shares: 22,
    location: 'Sedona, AZ',
    commentPreviews: [
      {
        user: 'Ivy Chen',
        avatar: 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=400',
        text: 'Need this kind of reset! Where’s the trailhead?',
      },
      {
        user: 'Rylan Park',
        avatar: 'https://images.pexels.com/photos/1129370/pexels-photo-1129370.jpeg?auto=compress&cs=tinysrgb&w=400',
        text: 'Nature shots + product vibes = inspo',
      },
    ],
  },
]
